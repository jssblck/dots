...
This repository backs up my user-level agent config (Claude Code, Codex, and
shared cross-agent files). It is kept in sync by an agent routine that runs both
